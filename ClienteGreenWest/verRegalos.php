        ...
        <section class="dashboard">
            <div class="top">
                ...
                <div class="d-flex flex-row" id="enca">
                    <div class="p-2">
                        <i class="uil uil-store"></i>
                        <span class="text">Ver Regalos</span>
                    </div>
                    <div class="p-2">
                        <?php
                        session_start();
            ...
            <div class="dash-content">
                <table class="table table-striped table-hover" style="margin-top: 10%;">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <th scope="row"><?php echo $list->id_regalo ?></th>
                                <td><?php echo $list->nombre ?></td>
                                <td>
                                    <img src="http://127.0.0.1:8000<?php echo $list->imagen ?>" alt="" width="20%" height="35%">
                                </td>
                                <td><?php echo $list->costePuntos ?></td>
                                <td><?php echo $list->cantidad ?></td>
                                <td>
                                    <button type="button" class="btn btn-info"><i class="uil uil-edit-alt" style="font-size: 17px; color:white;"></i> </button>
                                    <button type="button" class="btn btn-danger"><i class="uil uil-times-circle" style="font-size: 17px; color:white;"></i> </button>
